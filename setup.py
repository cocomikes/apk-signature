...
#from apk_signature.version import __version__
lines = open(here + '/apk_signature/version.py', mode='r').readlines()
for line in lines:
...
setuptools.setup(
    ...
    url = 'https://github.com/floatinghotpot/apk-signature',
    download_url = 'https://github.com/floatinghotpot/apk-signature',
    ...
    entry_points={'console_scripts': ['apk-signature=apk_signature:cli_main']},
